...
<cffunction name="init" access="public" returntype="dao" output="false">
...
<!--- ABSTRACT CLASS - all functions must be overridden --->

	<cffunction name="create" access="public" returntype="any" output="false">
		<cfthrow message="This function must be overriden from the base class" />
	</cffunction>
